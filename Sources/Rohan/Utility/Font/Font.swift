...
public struct Font {
    ...
    public var glyphCount: Int { Int(CTFontGetGlyphCount(ctFont)) }
                                 ...
                                 _ rects: inout [CGRect]) -> CGRect
    {
        ...
        return CTFontGetBoundingRectsForGlyphs(ctFont, CTFontOrientation.default,
                            ...
                            _ advances: inout [CGSize]) -> CGFloat
    {
        ...
        return CTFontGetAdvancesForGlyphs(ctFont, orientation,
    ...
    public func drawGlyphs(_ glyphs: [GlyphId], _ positions: [CGPoint],
                           _ context: CGContext)
    {
