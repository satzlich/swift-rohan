...
class ExpressionRewriter<C>: ExprVisitor<C, Expr> {
  ...
  override func visit(itemList: ItemListExpr, _ context: C) -> R {
    _rewriteElement(itemList, context)
  }
  ...
  override func visit(parList: ParListExpr, _ context: C) -> Expr {
    _rewriteElement(parList, context)
  }
