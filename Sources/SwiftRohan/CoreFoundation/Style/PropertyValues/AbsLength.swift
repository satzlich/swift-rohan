...
/// Absolute length
///
/// Supported units: points, millimeters, centimeters, picas, inches
public struct AbsLength: Equatable, Hashable, Codable, Sendable {
...
extension AbsLength: CustomDebugStringConvertible {
  public var debugDescription: String { "\(rawValue)" }
}

extension AbsLength: CustomStringConvertible {
  public var description: String { String(format: "%.2f", ptValue) }
}
