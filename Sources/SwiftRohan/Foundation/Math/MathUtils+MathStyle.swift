...
extension MathUtils {
  ...
  /// Given the style of a formula with a subscript and/or a superscript, return
  /// the style of the subscript/superscript.
  ...
  /// - Note: This applies to matrix/cases nodes. For aligned node, use identity.
