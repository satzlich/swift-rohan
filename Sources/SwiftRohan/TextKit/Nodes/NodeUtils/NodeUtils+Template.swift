...
private final class ExprToNodeVisitor: ExprVisitor<Void, Node> {
  ...
  override func visit(mathLimits: MathLimitsExpr, _ context: Void) -> Node {
    let nucleus = _convertChildren(of: mathLimits.nucleus, context)
    return MathLimitsNode(mathLimits.mathLimits, nucleus)
  }
  ...
  override func visit(mathVariant: MathVariantExpr, _ context: Void) -> Node {
    ...
    return MathVariantNode(mathVariant.mathTextStyle, nucleus)
  }
