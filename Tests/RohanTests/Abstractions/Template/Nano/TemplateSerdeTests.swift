...
struct TemplateSerdeTests {
  ...
  func test_Template() throws {
    ...
    try assertSerde(
      template,
      """
      {"body":[{"string":"Hello, ","type":"text"},{"layoutType":0,"name":"x","type":"variable"}],"layoutType":0,"name":"test","parameters":["x"]}
      """)
  }
  ...
  func test_CompiledTemplate() throws {
    ...
    let template = CompiledTemplate(
      "test", [TextExpr("Hello, "), CompiledVariableExpr(0, .inline)],
      .inline, [argument0])
    try assertSerde(
      template,
      """
      {"body":[{"string":"Hello, ","type":"text"},{"argIndex":0,"layoutType":0,"levelDelta":0,"type":"cVariable"}],"layoutType":0,"lookup":[[[{"index":{"_0":1}}]]],"name":"test"}
      """)
  }
