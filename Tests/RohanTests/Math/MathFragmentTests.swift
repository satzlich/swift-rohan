...
struct MathFragmentTests {
    ...
    static func drawSample(_ fontName: String, _ bounds: CGRect, _ cgContext: CGContext) {
        ...
        cgContext.textMatrix = .identity
        Self.createAndDrawVariants(mathContext, leftBrace, smallX, .vertical,
                                   CGPoint(x: originX + 5, y: originY + 77),
                                   [10, 30, 50, 70, 90],
                                   cgContext)
        Self.createAndDrawVariants(mathContext, leftCeil, smallX, .vertical,
                                   CGPoint(x: originX + 85, y: originY + 77),
                                   [10, 30, 50, 70, 90],
                                   cgContext)

        Self.createAndDrawVariants(mathContext, circumflex, smallX, .horizontal,
                                   CGPoint(x: originX + 215, y: originY + 77),
                                   [10, 14, 18, 22, 26],
                                   cgContext)
        Self.createAndDrawVariants(mathContext, topBrace, smallX, .horizontal,
