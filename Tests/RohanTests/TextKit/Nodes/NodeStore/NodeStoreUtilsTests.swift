...
struct NodeStoreUtilsTests {
  ...
  func tagSet() {
    ...
    let expected = [
      ...
      "acute", "aleph", "align*", "aligned", "alpha", "amalg", "angle", "approx",
      "approxeq",
      ...
      "diamond", "diamondsuit", "digamma", "dim", "displaymath", "displaystyle", "div",
      "divideontimes", "document",
      ...
      "lgroup", "lhd", "lim", "liminf", "limits", "limsup", "linebreak", "ll", "llcorner",
      "lll",
      ...
      "multline*", "nLeftarrow", "nLeftrightarrow", "nRightarrow", "nVDash", "nVdash",
      "nabla", "natural", "ncong", "ne", "nearrow", "neg", "neq", "nexists", "ngeq",
      "ngtr", "ni", "nleftarrow", "nleftrightarrow", "nleq", "nless", "nmid", "nolimits",
      "notin",
      ...
      "text", "textbf", "textit", "textstyle", "tfrac", "therefore", "theta",
      ...
      "widetilde", "wp", "wr",
      "xLeftarrow", "xLeftrightarrow", "xRightarrow", "xhookleftarrow", "xhookrightarrow",
      "xi", "xleftarrow", "xleftharpoondown", "xleftharpoonup", "xleftrightarrow",
      "xleftrightharpoons", "xmapsto", "xrightarrow", "xrightharpoondown",
