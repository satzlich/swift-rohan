...
struct NodeStoreUtilsTests {
  ...
  func tagSet() {
    ...
    let expected = [
      ...
      "nparallel", "npolint", "nprec", "npreceq", "nrightarrow", "nsim", "nsubseteq",
      "nsucc", "nsucceq", "nsupseteq", "ntriangleleft", "ntrianglelefteq",
      ...
      "ulcorner", "underbrace", "underbracket", "underline", "underparen", "uparrow",
