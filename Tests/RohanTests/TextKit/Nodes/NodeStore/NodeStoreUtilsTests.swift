...
struct NodeStoreUtilsTests {
  ...
  func tagSet() {
    ...
    let expected = [
      ...
      "blacktriangleleft", "blacktriangleright", "bmatrix", "bmod", "bot", "bowtie",
      ...
      "delta", "det", "dfrac", "diagdown", "diagup", "diameter", "diamond", "diamondsuit",
      "digamma", "dim", "displaymath", "displaystyle", "div", "divideontimes", "document",
      ...
      "longmapsto", "longrightarrow", "looparrowleft", "looparrowright", "lor", "lozenge",
      "lrcorner", "lrdelim", "ltimes", "lvert", "maltese", "mapsto", "mathbb", "mathbf",
      ...
      "nrightarrow", "nsim", "nsubseteq", "nsucc", "nsucceq", "nsupseteq",
      "ntriangleleft", "ntrianglelefteq", "ntriangleright", "ntrianglerighteq", "nu",
      "nvDash", "nvdash", "nwarrow", "odot", "oiiint", "oiint", "oint", "omega", "ominus",
      ...
      "overset", "owns", "paragraph", "parallel", "partial", "perp", "phi", "pi",
      ...
      "twoheadrightarrow", "ulcorner", "underbrace", "underbracket", "underleftarrow",
      "underleftrightarrow", "underline", "underparen", "underrightarrow", "underset",
      "unlhd", "unrhd", "uparrow", "updownarrow", "upharpoonleft", "upharpoonright",
      "uplus", "upsilon", "upuparrows", "urcorner", "vDash", "varDelta", "varepsilon",
      "varinjlim", "varkappa", "varliminf", "varlimsup", "varnothing", "varphi", "varpi",
      "varprojlim", "varrho", "varsigma", "vartheta", "vartriangle", "vartriangleleft",
      "vartriangleright", "vdash", "vdots", "vec", "vee", "veebar", "vert", "vmatrix",
      "wedge", "widebreve", "widecheck", "widehat", "wideoverbar", "widetilde", "wp",
      "wr", "xLeftarrow", "xLeftrightarrow", "xRightarrow", "xhookleftarrow",
      "xhookrightarrow", "xi", "xleftarrow", "xleftharpoondown", "xleftharpoonup",
      "xleftrightarrow", "xleftrightharpoons", "xmapsto", "xrightarrow",
