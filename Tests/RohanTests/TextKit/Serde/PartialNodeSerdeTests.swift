...
final class PartialNodeSerdeTests: TextKitTestsBase {
  ...
  func test_PartialNode() throws {
    ...
    let location: TextLocation = {
      ...
      return TextLocation(path, "Hel".utf16.count)
    }()
    ...
    do {
      ...
      let endLocation = TextLocation(endPath, "world".utf16.count)
    ...
    do {
      ...
      let endLocation = TextLocation(endPath, "The quick".utf16.count)
      let range = RhTextRange(location, endLocation)!
